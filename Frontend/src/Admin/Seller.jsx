          ...
          <tbody>
            {users.map((item, index) => (
              <tr key={item._id}>
                ...
                <td>{item.email}</td>
                <td>
                  <button style={{ border: 'none', background: 'black' }}>
                    <Link to={`/useredit/${item._id}`} style={{ color: 'white', textDecoration: 'none' }}>
                      <FaEdit />
                    </Link>
                  </button>
                  <button onClick={() => deleteData(item._id)} style={{ border: 'none', color: 'white', background: 'black' }}>
                    <FaTrash />
                  </button>{' '}
